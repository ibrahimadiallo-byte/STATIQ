    ...
    <section className="pb-6">
      <section className="rounded-3xl bg-gradient-to-br from-[#1b2a7a] via-[#1520A6] to-[#4f6bff] p-5 shadow-2xl">
        ...
        <div className="mt-6">
          ...
          <p className="text-4xl font-black italic tracking-wide text-white/70">
            LIVE
          </p>
      ...
      <section className="mt-6">
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          {[
            { name: "Mbappe", stat: "xG 0.62/90" },
            { name: "Bellingham", stat: "Chances 3.1/90" },
            { name: "Saka", stat: "Assists 11" },
            { name: "Rice", stat: "Recoveries 8.4" },
          ].map((player) => (
            <div
              key={player.name}
